...
(
    ...
    path                varchar(511)    not null        collate utf8_bin                        comment '文件路径',
...
(
    ...
    request_method      varchar(15)     not null                                                comment 'http请求method，GET HEAD POST PUT DELETE CONNECT OPTIONS TRACE PATCH',
