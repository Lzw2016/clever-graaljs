...
/**
 * 作者：lizw <br/>
 * 创建时间：2021/06/11 15:59 <br/>
 */
@Slf4j
public class EncodeDecodeUtilsTest {
    @Test
    public void t01() throws IOException {
        String code = IOUtils.resourceToString("/builtin/EncodeDecodeUtilsTest.js", StandardCharsets.UTF_8);
