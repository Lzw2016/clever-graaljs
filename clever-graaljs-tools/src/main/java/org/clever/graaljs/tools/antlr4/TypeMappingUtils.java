...
public class TypeMappingUtils {
    ...
    static {
        ...
        TYPE_MAPPING.put("Collection<?>", "JCollection<any>");
        TYPE_MAPPING.put("Date", "JDate");
        TYPE_MAPPING.put("Enumeration", "JEnumeration");
        TYPE_MAPPING.put("Iterable", "JIterable");
        TYPE_MAPPING.put("Iterable<?>", "JIterable<any>");
        TYPE_MAPPING.put("Iterator", "JIterator");
        TYPE_MAPPING.put("Iterator<?>", "JIterator<any>");
        TYPE_MAPPING.put("List", "JList");
        TYPE_MAPPING.put("List<?>", "JList<any>");
        TYPE_MAPPING.put("Map", "JMap");
        TYPE_MAPPING.put("Map<String, Object>", "JMap<JString, any>");
        TYPE_MAPPING.put("Map<String, String>", "JMap<JString, JString>");
        TYPE_MAPPING.put("MapEntry", "JMapEntry");
        TYPE_MAPPING.put("Set", "JSet");
        TYPE_MAPPING.put("Set<String>", "JSet<JString>");
