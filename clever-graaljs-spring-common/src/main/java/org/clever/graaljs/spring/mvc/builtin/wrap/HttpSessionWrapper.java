...
public class HttpSessionWrapper {
    ...
    private final org.clever.graaljs.spring.mvc.builtin.adapter.HttpSessionWrapper delegate;

    protected HttpSessionWrapper(org.clever.graaljs.spring.mvc.builtin.adapter.HttpSessionWrapper session) {
